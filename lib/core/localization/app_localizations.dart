...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'export_excel_desc': 'Save all products and categories to Excel file',
      'import_excel': 'Import from Excel',
      'import_excel_desc': 'Load products and categories from Excel file',
      'export_success': 'Export successful! File saved to:',
      'import_success': 'Import successful!',
      'import_warning': 'This will replace all existing products and categories. Continue?',
      'import': 'Import',
      'products': 'products',
    ...
    'ru': {
      ...
      'export_excel_desc': 'Сохранить все продукты и категории в Excel',
      'import_excel': 'Импорт из Excel',
      'import_excel_desc': 'Загрузить продукты и категории из Excel',
      'export_success': 'Экспорт успешен! Файл сохранен:',
      'import_success': 'Импорт успешен!',
      'import_warning': 'Это заменит все существующие продукты и категории. Продолжить?',
      'import': 'Импорт',
      'products': 'продуктов',
    ...
    'tk': {
      ...
      'delete_product': 'Haryt poz',
      'delete_confirm': 'Siz hakykatdanam pozmak isleýärsiňizmi',
      'product_deleted': 'Haryt üstünlikli pozuldy',
      'export_excel': 'Excel-e aktar',
      'export_excel_desc': 'Ähli harytlary we kategoriýalary Excel-e ýatda sakla',
      'import_excel': 'Excel-den import et',
      'import_excel_desc': 'Harytlary we kategoriýalary Excel-den ýükle',
      'export_success': 'Eksport üstünlikli! Faýl ýatda saklandy:',
      'import_success': 'İmport üstünlikli!',
      'import_warning': 'Bu ähli bar bolan harytlary we kategoriýalary çalyşar. Dowam etmeli?',
      'import': 'İmport',
      'products': 'haryt',
